...
* New splitter entities sized to match **one belt lane**
* Allows separating, redirecting, or managing items **per lane**
* Designed for clean and compact belt layouts
* Works with standard belts and belt mechanics

No configuration is required. Place and use them like regular belt components.

---

## ⚠️ Warnings

* 🚨 **This MOD changes how belt routing is normally solved**
* ➗ Enables very precise item control that may simplify logistics puzzles
* 🧪 Recommended for:

  * Advanced belt designs
  * Compact factories
  * Testing and creative builds
* ✔ Compatible with vanilla and most belt-related mods
